...
select title 제목, price 가격 from books where price > 20000  ;
...
select * from books order by pub_date desc , title asc;
...
select author , title from books where author not like '이%';
