...
public class AccountView {  // AccountView class start
    ...
    public void accountDeposit(){
        ...
        if (alert == 2) { System.out.println("[경고] 계좌내역이 가득찼습니다. 창구에 문의하세요. ");}             // 만약 addAlert가 false 라면 ?
        if (alert == 3) { System.out.println("[경고] 계좌정보가 일치하지 않습니다."); }
    ...
    public void accountWithdraw(){
        ...
        {System.out.println("[안내] 출금이 완료되었습니다.");}   // 만약 withdrawAlert 리턴값이 1이라면?
        { System.out.println("[경고] 잔액이 부족합니다.");}    // 만약 withdrawAlert 리턴값이 2라면?
    ...
    public void accountBalance(){
        ...
        System.out.println("[잔고] "+ "원"); // 잔고로 seeAlert 리턴값 출력

        { System.out.println("[경고] 계좌정보가 일치하지 않습니다.");} // seeAlert 리턴값이 -1이라면?
    ...
    public void accountTransfer(){
        ...
        System.out.println("[경고] 잔액이 부족합니다.");  // 만약 seeAlert가 2라면? 잔액 부족
        System.out.println("[경고] 받으실 계좌가 조회되지 않습니다.");    // 만약 seeAlert가 3이라면? 받는 계좌정보 없음
        System.out.println("[경고] 이체할 계좌와 이체 받을 계좌가 일치합니다.");    // 만약 seeAlert가 0이라면? 보낼 계좌번호와 받을 계좌번호 일치로 인한 오류
        System.out.println("[경고] 계좌정보가 일치하지 않습니다.");   // 만약 seeAlert가 리턴값이 4라면? 보낼 계좌번호에서 계좌번호가 없던가 비밀번호가 틀리던가 둘 중 하나겠죠
        { System.out.println("[경고] 에러가 발생했습니다."); }
    }   // func end
